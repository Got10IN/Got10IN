...
const MentorCard = ({ 
    id,daysJoined, name, alumni, 
    rating, ratingQuantity, yearsOfExperience,topic1, topic2, 
    aiChattingPrice, totalSubscriber, oneOnonePrice, totalHour, mentorPic, button:Button}: IMentorCard) => {
    return (
                ...
                <div className="container mx-auto px-4 text-center mt-2 sm:text-left md:text-left whitespace-pre">
                    ...
                    <div className="text-sm font-medium text-slate-700 mb-4 space-y-2">                   
                        <div className='flex items-center'>
                            ...
                            <p>
                                {rating} <span className='text-slate-500'>({ratingQuantity})</span> reviews
                            </p>    
                        </div>   
                    ...
                    <div className="columns-2 gap-8 mb-2.5">
                        <div className="text-sm text-black space-y-1">
                            ...
                            <p className="text-sm font-normal ">
                                Total subscriber {' '}
                                <span className='text-xs text-indigo-300'> {totalSubscriber} + </span>
                            </p> 
                        </div>
                        <div className="text-sm text-black space-y-1">
                            <p className="text-sm font-medium ">
                            ...
                            <p className="text-sm font-normal">
                                Total hour {' '}
                                <span className='text-xs text-indigo-300'> {totalHour} hr</span>
                            </p> 
                        </div> 
                    </div>
                    <Button/>
