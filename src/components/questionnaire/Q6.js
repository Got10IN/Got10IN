...
function TendencySlider({ onValueChange }) {
    ...
    return (
        <div className="tendency-slider" style={{ paddingTop: '2%'}}>
            <div className="slider-label">🤓Hardcore</div>
            <input
                type="range"
                min="0"
                max="100"
                ...
                style={{  width: '70%'}}
            />
            <div className="slider-label">🥳Party</div>
        </div>
    );
}
        ...
        <div className="Q-fullscreen-container" style={{paddingTop:'15%',paddingBottom:'10%'}}>
            ...
            <div className="Q-center-container">
                ...
                <div className='Q-Button-container' style={{flex:'0.98'}}>
                    <Link to="/question5" className="small-button" style={{backgroundColor:'#96B2CF',height:'100%',padding:'1% 4%'}}>&lt;</Link>
                    <div className="skip-button-container">
                        <Link to="/question7" className="small-text-blue">Skip</Link>
                    </div>
                    <Link to="/question7" className="small-button" style={{backgroundColor:'#003362',height:'100%',padding:'1% 4%'}}>&gt;</Link>
                </div>
            </div>
        </div>
    );
