        ...
        <div className="Q-fullscreen-container" style={{paddingTop:'15%',paddingBottom:'10%'}}>
            ...
            <div className="Q-center-container" style={{ paddingTop: '5%' }}>
                ...
                <div className='Q-Button-container' style={{flex:'0.98'}}>
                    <Link to="/question3" className="small-button" style={{backgroundColor:'#96B2CF',height:'100%',padding:'1% 4%'}}>&lt;</Link>
                    <div className="skip-button-container">
                        <Link to="/question5" className="small-text-blue">Skip</Link>
                    </div>
                    <Link to="/question5" className="small-button" style={{backgroundColor:'#003362',height:'100%',padding:'1% 4%'}}>&gt;</Link>
                </div>
            </div>
        </div>
    );
